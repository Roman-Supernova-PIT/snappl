...
class Config:
    ...
    * python's yaml reading of floats is broken.  It will read 1e10 as a
    ...
    #   SNAPPL_CONFIG env var to try to figure out what to read.
    _default_default = os.getenv( 'SNAPPL_CONFIG', None )
    ...
    def get( configfile=None, setdefault=None, static=True ):
        ...
        configfile : str or Pathlib.Path, default None
            ...
            SNAPPL_CONFIG, but see "setdefault" below.  If that env
        ...
        setdefault : bool, default None
            ...
            the configfile in SNAPPL_CONFIG will be read and set to the
            ...
            read the config file in SNAPPL_CONFIG and make that the
            ...
            reason, you want to the config in SNAPPL_CONFIG but not
