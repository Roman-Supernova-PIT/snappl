...
class ImageCollectionOU2024:
    ...
    def get_image( self, image_id=None, path=None, observation_id=None, band=None, sca=None, base_path=None, dbclient=None ):
        ...
        if path is not None:
            ...
            if ( observation_id is not None ) and ( int(observation_id) != int(img.observation_id) ):
                raise ValueError( "Pointing {observation_id} inconsistent with what's in {path}" )
